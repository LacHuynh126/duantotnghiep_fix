...
const modelComment = require('../model/modelChat');
...
exports.getListComment = async (names_get) => {
    const checkComment = await modelComment.find({content:{$elemMatch:{names_get:names_get}}});
    return checkComment;
}
